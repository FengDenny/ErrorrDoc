...
exports.emailReVerify = (url) => {
  return `
          <table align="center" cellpadding="0" cellspacing="0"  >
          <tr>
              <td style="padding: 20px 0 30px 0;">
                  <h1 style="margin: 0; color:red; text-align:center">Please use the following link to activate your email</h1>
              </td>
          </tr>
          <tr>
              <td style="padding: 20px 0 30px 0;">
                  <a href="${url}" style="margin: 0; color:gray; width:700px; line-height:20px">Activate your email</a>
              </td>
          </tr>
          <tr>
            <td style="padding: 20px 0 30px 0;">
...
exports.emailReActivated = (loginURL) => {
  return `
    <table align="center" cellpadding="0" cellspacing="0"  >
    <tr>
        <td style="padding: 20px 0 30px 0;">
            <h1 style="margin: 0; color:red; text-align:center">Thank you! Your email has been activated!</h1>
        </td>
    </tr>
    <tr>
        <td style="padding: 20px 0 30px 0;">
